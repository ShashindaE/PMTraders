...
@mock.patch("pmtraders.plugins.email_common.send_mail")
...
@mock.patch("pmtraders.plugins.user_email.tasks.send_email")
...
@mock.patch(
    "pmtraders.plugins.user_email.tasks.account_events.customer_email_changed_event"
)
@mock.patch("pmtraders.plugins.email_common.send_mail")

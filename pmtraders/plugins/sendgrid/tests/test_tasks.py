...
@patch("pmtraders.plugins.sendgrid.tasks.Mail")
@patch("pmtraders.plugins.sendgrid.tasks.SendGridAPIClient.send")
def test_send_email(
...
@patch("pmtraders.plugins.sendgrid.tasks.send_email")

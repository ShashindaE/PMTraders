...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "pmtraders.settings")

app = Celery("pmtraders", task_cls="pmtraders.core.tasks:RestrictWriterDBTask")

app.config_from_object("django.conf:settings", namespace="CELERY")
app.autodiscover_tasks()
app.autodiscover_tasks(
    packages=[
        "pmtraders.order.migrations.tasks",
        "pmtraders.account.migrations.tasks",
        "pmtraders.attribute.migrations.tasks",
    ],
    related_name="pmtraders3_22",
)

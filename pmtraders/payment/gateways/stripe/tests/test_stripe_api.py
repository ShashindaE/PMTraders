...
from pmtraders.payment.utils import price_to_minor_unit
...
@patch(
    "pmtraders.payment.gateways.stripe.stripe_api.stripe.WebhookEndpoint",
)
...
def test_subscribe_webhook_returns_webhook_object(mocked_webhook, channel_USD):
    api_key = "api_key"
    expected_url = (
        "https://example.com/plugins/channel/main/pmtraders.payments.stripe/webhooks/"
    )
...
@patch(
    "pmtraders.payment.gateways.stripe.stripe_api.stripe.PaymentIntent",
)
...
@patch(
    "pmtraders.payment.gateways.stripe.stripe_api.stripe.PaymentMethod",
)
...
@patch(
    "pmtraders.payment.gateways.stripe.stripe_api.stripe.Refund",
)
...
@patch(
    "pmtraders.payment.gateways.stripe.stripe_api.stripe.Customer",
)

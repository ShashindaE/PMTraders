...
@mock.patch("pmtraders.payment.gateways.adyen.plugin.call_refund")
def test_handle_authorization_for_checkout_out_of_stock_after_payment(
    ...
    with race_condition.RunBefore(
        "pmtraders.checkout.complete_checkout._create_order",
...
@mock.patch("pmtraders.payment.gateways.adyen.webhooks.order_refunded")
...
@mock.patch("pmtraders.payment.gateways.adyen.webhooks.handle_refund")
...
@mock.patch("pmtraders.payment.gateways.adyen.webhooks.handle_cancellation")
...
@patch("pmtraders.payment.gateway.void")
@mock.patch("pmtraders.payment.gateways.adyen.webhooks.call_refund")
@patch("pmtraders.checkout.complete_checkout._get_order_data")
def test_order_closed_with_adyen_partial_payments_unable_to_create_order(
    ...
    merchant_account = "pmtradersEcom"

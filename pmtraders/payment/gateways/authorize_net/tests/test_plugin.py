...
@mock.patch("pmtraders.payment.gateways.authorize_net.plugin.authenticate_test")
...
@mock.patch("pmtraders.payment.gateways.authorize_net.plugin.refund")
...
@mock.patch("pmtraders.payment.gateways.authorize_net.plugin.authorize")
...
@mock.patch("pmtraders.payment.gateways.authorize_net.plugin.capture")
...
@mock.patch("pmtraders.payment.gateways.authorize_net.plugin.process_payment")
...
@mock.patch("pmtraders.payment.gateways.authorize_net.plugin.list_client_sources")

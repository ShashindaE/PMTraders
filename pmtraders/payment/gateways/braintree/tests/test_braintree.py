...
def test_get_error_for_client(braintree_error, monkeypatch):
    ...
    monkeypatch.setattr("pmtraders.payment.gateways.braintree.ERROR_CODES_WHITELIST", {})
    assert get_error_for_client([error]) == DEFAULT_ERROR

    monkeypatch.setattr(
        "pmtraders.payment.gateways.braintree.ERROR_CODES_WHITELIST",
...
@patch("pmtraders.payment.gateways.braintree.get_braintree_gateway")

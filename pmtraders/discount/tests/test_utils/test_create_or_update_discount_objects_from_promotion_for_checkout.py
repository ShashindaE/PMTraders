...
@patch("pmtraders.discount.utils.checkout.base_checkout_delivery_price")
@patch("pmtraders.discount.utils.checkout.base_checkout_subtotal")
...
def test_create_discount_objects_for_order_promotions_race_condition(
    ...
    with race_condition.RunBefore(
        "pmtraders.discount.utils.checkout.create_checkout_discount_objects_for_order_promotions",
...
def test_create_or_update_order_discount_race_condition(
    ...
    with race_condition.RunBefore(
        "pmtraders.discount.utils.checkout._set_checkout_base_prices", call_update
    ):
        call_update()
...
def test_create_checkout_line_discount_objects_for_catalogue_promotions_race_condition(
    ...
    with race_condition.RunBefore(
        "pmtraders.discount.utils.checkout.prepare_checkout_line_discount_objects_for_catalogue_promotions",

...
@patch("pmtraders.warehouse.availability.check_preorder_threshold_in_orders")
@patch("pmtraders.warehouse.availability.check_stock_quantity")
...
@patch("pmtraders.warehouse.availability.check_preorder_threshold_bulk")
@patch("pmtraders.warehouse.availability.check_stock_quantity_bulk")

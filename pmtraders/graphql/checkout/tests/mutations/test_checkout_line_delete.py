...
@mock.patch(
    "pmtraders.graphql.checkout.mutations.checkout_line_delete."
    "update_checkout_shipping_method_if_invalid",
    wraps=update_checkout_shipping_method_if_invalid,
)
@mock.patch(
    "pmtraders.graphql.checkout.mutations.checkout_line_delete.invalidate_checkout",
...
@patch(
    "pmtraders.graphql.checkout.mutations.checkout_line_delete.call_checkout_info_event",

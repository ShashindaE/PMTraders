...
def patch_get_buffer(buffer):
    with patch(
        "pmtraders.webhook.observability.utils.get_buffer", return_value=buffer
    ) as get_buffer:
        yield get_buffer
...
def patch_get_webhooks(observability_webhook_data):
    with patch(
        "pmtraders.webhook.observability.utils.get_webhooks",
...
@patch("pmtraders.webhook.observability.utils.cache.get")
@patch("pmtraders.webhook.observability.utils.get_webhooks_for_event")
...
@patch("pmtraders.webhook.observability.utils.ApiCall.report")
...
@patch("pmtraders.webhook.observability.utils.put_event")

...
LOGGING = {
    ...
    "formatters": {
        ...
        "json": {
            "()": "pmtraders.core.logging.JsonFormatter",
        ...
        "celery_json": {
            "()": "pmtraders.core.logging.JsonCeleryFormatter",
            "datefmt": "%Y-%m-%dT%H:%M:%SZ",
            "format": (
        ...
        "celery_task_json": {
            "()": "pmtraders.core.logging.JsonCeleryTaskFormatter",
            "datefmt": "%Y-%m-%dT%H:%M:%SZ",
            "format": (
                "%(asctime)s %(levelname)s %(celeryTaskId)s %(celeryTaskName)s "
                "%(message)s "
...
BUILTIN_PLUGINS = [
    ...
    # "pmtraders.payment.gateways.adyen.plugin.AdyenGatewayPlugin",
    # "pmtraders.payment.gateways.authorize_net.plugin.AuthorizeNetGatewayPlugin",
    # "pmtraders.payment.gateways.np_atobarai.plugin.NPAtobaraiGatewayPlugin",
    # "pmtraders.plugins.user_email.plugin.UserEmailPlugin",
    # "pmtraders.plugins.admin_email.plugin.AdminEmailPlugin",
    # "pmtraders.plugins.sendgrid.plugin.DeprecatedSendgridEmailPlugin",
    # "pmtraders.plugins.openid_connect.plugin.OpenIDConnectPlugin",
]

# Plugin discovery
EXTERNAL_PLUGINS = []
installed_plugins = importlib.metadata.entry_points(group="pmtraders.plugins")
